...
const ResultsView = () => {
  ...
  const [result, setResult] = useState<StudentAssessmentResult>({
    id: 'mock-result-id',
    studentId: '4',
    assessmentId: '1',
  ...
  useEffect(() => {
    ...
    const foundAssessment = mockAssessments.find(a => a.id === result.assessmentId);
    if (foundAssessment) {
              ...
              {assessment.questions?.map((question, index) => {
                ...
                const isCorrect = answer && (
                  question.type === 'multiple_choice' 
                    ? question.options?.find(o => o.id === answer.answer)?.isCorrect
                  ...
                  <div key={question.id} className="border-b pb-6 mb-6 last:border-b-0 last:mb-0 last:pb-0">
                    ...
                    <div className="bg-gray-50 p-3 rounded-md mb-3">
                      ...
                      {question.type === 'multiple_choice' && question.options && answer ? (
                        <p>{question.options.find(o => o.id === answer.answer)?.text || 'Sem resposta'}</p>
                      ) : (
